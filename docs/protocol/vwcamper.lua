...
local f_energy_IOneBattBemAfs = ProtoField.uint8("vwcamper.energy.IOneBattBemAfs", "IOneBattBemAfs", base.DEC, nil, 0xff)
local f_energy_PDcdcAfs = ProtoField.uint8("vwcamper.energy.PDcdcAfs", "PDcdcAfs", base.DEC, nil, 0xff)
...
local f_energy_ITwoBattBemAfs = ProtoField.uint16("vwcamper.energy.ITwoBattBemAfs", "ITwoBattBemAfs", base.DEC, nil, 0xffff)
local f_energy_IDcdcAfs = ProtoField.uint16("vwcamper.energy.IDcdcAfs", "IDcdcAfs", base.DEC, nil, 0xffff)
...
local f_vehicle_CarLevelRoll = ProtoField.uint16("vwcamper.vehicle.CarLevelRoll", "CarLevelRoll", base.DEC, nil, 0xffff)
local f_vehicle_CarLevelPitch = ProtoField.uint16("vwcamper.vehicle.CarLevelPitch", "CarLevelPitch", base.DEC, nil, 0xffff)
