...
# post-write applied-check moved to calictl.postcheck (so the daemon no longer imports
# up into the CLI for it). Re-exported here for the CLI + back-compat.
from .postcheck import set_check as _set_check  # noqa: E402
